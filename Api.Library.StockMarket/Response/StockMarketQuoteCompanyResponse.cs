...
namespace Api.Library.StockMarket.Response
{
    internal class StockMarketQuoteCompanyResponse
    {
        ...
        public DateTimeOffset? InitialPublicOfferingOn { get => InitialPublicOfferingOnAtEasternTimezone; set => InitialPublicOfferingOnAtEasternTimezone = value?.DateTime.SetTimezone(LibraryExtension.EasternTimezone); }
