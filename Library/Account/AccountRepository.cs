...
namespace Library.Account
{
    class AccountRepository : BaseRepository<AccountContext>, IAccountRepository
    {
        ...
        public async Task<AccountUserTypeEntity> GetUserTypeAsync(int userTypeId) =>
           await _context.UserTypes
               .FindAsync(userTypeId);

        public async Task<List<AccountUserGenderEntity>> GetUserGendersAsync() =>
            await _context.UserGenders
                .ToListAsync();

        public async Task<AccountUserGenderEntity> GetUserGenderAsync(int userGenderId) =>
            await _context.UserGenders
                .FindAsync(userGenderId);
    ...
    public interface IAccountRepository
    {
        ...
        Task<AccountUserTypeEntity> GetUserTypeAsync(int userTypeId);
        Task<List<AccountUserGenderEntity>> GetUserGendersAsync();
        Task<AccountUserGenderEntity> GetUserGenderAsync(int userGenderId);
    }
}