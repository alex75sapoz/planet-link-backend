...
namespace Api.Library.Location.Entity
{
    public class LocationCountryLanguageEntity
    {
        ...
        public virtual LocationLanguageEntity Language { get; internal set; }
    }
}

namespace Api.Library.Location.Entity.Configuration
{
    internal class CountryLanguageEntityConfiguration : IEntityTypeConfiguration<LocationCountryLanguageEntity>
    {
